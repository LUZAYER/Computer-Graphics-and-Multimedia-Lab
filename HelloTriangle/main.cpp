...
int main()
{
    ...
    // Using name as Window title
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Reyazul Islam", NULL, NULL);
    if (window == NULL)
    {
    ...
    // Applying 6 pointers of two triangles
    float vertices[] = {
    -0.6f, -0.2f, 0.0f, // left
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render
        // Applying background color Orange
...
void processInput(GLFWwindow *window)
{
    //Pressing key 'R' to terminate the window
